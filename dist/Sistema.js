...
class Sistema {
    ...
    setUp(config) {
        ...
        const vPequeno = new Vaso_1.default(pequeno.cantidad, pequeno.contenido);
        const vMediano = new Vaso_1.default(mediano.cantidad, mediano.contenido);
        const vGrande = new Vaso_1.default(grande.cantidad, grande.contenido);
